...
if __name__ == "__main__":
    ...
    output_folder = args.output_folder  # e.g., 'results_taskb/'
    ...
    best_ckpt = args.ckpt               # e.g., best-ckpt
    ...
    with open(f"{output_folder}/dev_pred.csv", "w") as f:
